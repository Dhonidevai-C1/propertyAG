          ...
          <SectionCard title="Quick actions" noPadding>
            <div className="flex flex-col p-2">
              <Link href={`/clients/${id}/edit`} className="w-full">
                <button className="w-full flex items-center gap-3 h-11 px-4 text-slate-600 font-bold text-sm rounded-xl hover:bg-slate-50 transition-colors text-left">
              ...
              <a 
                ...
                className="w-full"
              >
                <button className="w-full flex items-center gap-3 h-11 px-4 text-emerald-600 font-bold text-sm rounded-xl hover:bg-emerald-50 transition-colors text-left">
              ...
              <Link href={`tel:${client.phone}`} className="w-full">
                <button className="w-full flex items-center gap-3 h-11 px-4 text-emerald-600 font-bold text-sm rounded-xl hover:bg-emerald-50 transition-colors text-left uppercase tracking-tight">
